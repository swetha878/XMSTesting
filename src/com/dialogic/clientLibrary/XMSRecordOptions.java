 ...
 * Specifies whether previous input should be considered or ignored for 
 * the purpose of barge-in. 
 * 
 ...
 * will result in the recording phase starting immediately, and the 
 * prompt will not be played.
 * 
 * 
 * @param a_clearDBon 
 */
